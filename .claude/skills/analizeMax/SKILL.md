...
Report what was deleted. Never delete `LATEST.md`.
...
Then tell the user: the six grades, the single most important finding, and
where both reports are. Do not paste the full report into chat; it is a file.
